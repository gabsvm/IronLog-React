 ...
 * Offers "design from scratch" + the list of global templates.
 */
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 scroll-container">
            ...
            <div className="flex items-center gap-4 py-2">
                ...
                <span className="text-xs font-bold text-zinc-600 uppercase tracking-widest">
                    {lang === 'en' ? 'OR CHOOSE TEMPLATE' : 'O ELIGE PLANTILLA'}
                </span>
                <div className="h-px bg-zinc-800 flex-1" />
            </div>
            ...
            <div className="grid gap-3">
                {templates.map((tpl) => (
                    <button
                        ...
                        className="w-full bg-zinc-900 border border-zinc-800 p-4 rounded-2xl text-left hover:border-primary-600/50 transition-colors duration-base ease-natural relative overflow-hidden group"
                    >
                        {tpl.isPro && (
