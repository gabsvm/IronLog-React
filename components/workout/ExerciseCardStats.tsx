...
export const ExerciseCardStats: React.FC<Props> = ({
    ...
    return (
        <div className="flex items-center gap-2 px-1" aria-label={`${completedCount} of ${totalSets} sets completed`}>
            ...
            <span className={`text-[10px] font-black tabular-nums tracking-tight ${allDone ? 'text-green-500' : 'text-zinc-500'}`}>
