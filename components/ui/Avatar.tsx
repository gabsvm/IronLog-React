...
export const Avatar: React.FC<AvatarProps> = ({
    ...
    const inner = photoURL ? (
        ...
        <span className="font-black text-white tracking-tight" style={{ fontSize: size * 0.42 }}>
            {initial}
        </span>
    ) : (
    ...
    return (
        <button
            ...
            className="relative rounded-full overflow-hidden flex items-center justify-center bg-gradient-to-br from-zinc-700 to-zinc-900 border border-zinc-700 hover:border-zinc-500 active:scale-90 transition-[transform,border-color] duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
