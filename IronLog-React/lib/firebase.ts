...
// Check if config is valid (has keys and not placeholders)
...
if (isValidConfig) {
  ...
  console.warn("⚠️ Firebase config missing or incomplete. Please check your .env file. Cloud features disabled.");
}
